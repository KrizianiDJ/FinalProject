...
public class SLScanMatchingItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sl_scan_matching_items);
        ...
        doneBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Intent myIntent = new Intent(getApplicationContext(), ShoppingList.class);
    ...
    private void createCameraSource() {
        ...
        cameraPreview.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                if (ActivityCompat.checkSelfPermission(SLScanMatchingItems.this,android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    ActivityCompat.requestPermissions(SLScanMatchingItems.this, new String[]{android.Manifest.permission.CAMERA},
